...
module_step10_download_server <- function(id, step_pos, number_current_step, 
  ...
  moduleServer(id, function(input, output, session) {
    ...
    module_step10_01_script_download_server(id ="f01_script", step_pos, number_current_step, 
                                                        STR_STEP_NAME, default_list_step, 
                                                        APP_TOTEM, internal_TOOLS_SELECTOR,
                                                        internal_CFG, internal_PLAY)
    ...
    module_step10_02_all_download_server(id ="f02_all", step_pos, number_current_step, 
                                            STR_STEP_NAME, default_list_step, 
                                            APP_TOTEM, internal_TOOLS_SELECTOR,
                                            internal_CFG, internal_PLAY)
    
    module_step10_03_report_download_server(id ="f03_report", step_pos, number_current_step, 
                                         STR_STEP_NAME, default_list_step, 
                                         APP_TOTEM, internal_TOOLS_SELECTOR,
                                         internal_CFG, internal_PLAY)
  })
