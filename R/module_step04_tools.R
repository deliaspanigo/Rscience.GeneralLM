#' @export
module_step04_tools_ui <- function(id) {
  ns <- NS(id)
...
#' @export
module_step04_tools_server <- function(id, step_pos, number_current_step, 
  ...
  moduleServer(id, function(input, output, session) {
    ...
    observe({
      ...
      pack_output <- internal_TOOLS_SELECTOR$"pack_output"
      ...
      new_list_step$"key"            <- "tool_selection"#sys.function()
