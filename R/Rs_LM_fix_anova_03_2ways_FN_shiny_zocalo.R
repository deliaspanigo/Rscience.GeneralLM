#' @export
Rs_LM_fix_anova_03_2ways_FN_shiny_zocalo <- function(internal_VARIABLE_SELECTOR){
  ...
  value_factor01 <- info_VS$"var_name_factor01"
  value_factor02 <- info_VS$"var_name_factor02"
  ...
  div(
    ...
    div(
      ...
      div(class = "me-4 mb-2",
          span(class = "fw-bold", "Factor01: "),
          span(value_factor01, style = "font-family: monospace;")
      ),
      div(class = "me-4 mb-2",
          span(class = "fw-bold", "Factor02: "),
          span(value_factor02, style = "font-family: monospace;")
      ),
