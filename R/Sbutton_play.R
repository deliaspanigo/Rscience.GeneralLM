...
Sbutton_play_server <- function(id, valores_default, valores_internos, valores_activos) {
  moduleServer(id, function(input, output, session) {
    ...
    observe({
      button_state(valores_internos$button_class_play)
    ...
    observeEvent(valores_internos$pack_var_selection, {
      ...
      valores_internos$button_class_play <-  valores_default$button_class_play
    ...
    observeEvent(input$btn_play, {
      ...
      valores_internos$button_class_play <- "confirmed"
