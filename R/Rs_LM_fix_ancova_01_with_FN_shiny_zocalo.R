#' @export
Rs_LM_fix_ancova_01_with_FN_shiny_zocalo <- function(internal_VARIABLE_SELECTOR){
  ...
  value_cov <- info_VS$"var_name_cov"
  ...
  div(
    ...
    div(
      ...
      div(class = "me-4 mb-2",
          span(class = "fw-bold", "Covariable: "),
          span(value_cov, style = "font-family: monospace;")
      ),
