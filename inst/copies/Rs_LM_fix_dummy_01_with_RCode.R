...
#' @export
Rs_LM_fix_dummy_01_with_RCode <- function(my_dataset, var_name_rv, var_name_dummy, var_name_reg, alpha_value){
  ...
  #---var_name_dummy <- "_B_var_name_dummy_B_"
  #---alpha_value     <- _B_alpha_value_B_
  
  # # # # # Section 04 - Standard actions --------------------------------------
  # The factor must be factor data type on R.
  my_dataset[,var_name_dummy] <- as.factor(as.character(my_dataset[,var_name_dummy]))
  ...
  vector_name_selected_vars <- c(var_name_rv, var_name_dummy)
