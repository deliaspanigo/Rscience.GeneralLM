...
#' @export
Rs_LM_fix_anova_03_2ways_RCode <- function(my_dataset, var_name_rv, var_name_factor01, var_name_factor02, alpha_value){
  ...
  #---var_name_factor01 <- "_B_var_name_factor01_B_"
  #---var_name_factor02 <- "_B_var_name_factor02_B_"
  #---alpha_value     <- _B_alpha_value_B_
  
  # # # # # Section 04 - Standard actions --------------------------------------
  # The factor must be factor data type on R.
  my_dataset[,var_name_factor01] <- as.factor(as.character(my_dataset[,var_name_factor01]))
  ...
  vector_name_selected_vars <- c(var_name_rv, var_name_factor01, var_name_factor02)
