---
title: "Anova 2 Ways - Fixed Model - General Linear Models"
format: 
  html:
    page-layout: custom
    margin-left: 0%
...
params:
  my_dataset: NULL
  var_name_rv: NULL
  var_name_factor01: NULL
  var_name_factor02: NULL
  alpha_value: NULL
---
...
var_name_factor01 <- params$"var_name_factor01"
var_name_factor02 <- params$"var_name_factor02"
alpha_value <- as.numeric(as.character(params$"alpha_value"))

my_super_list <- Rscience.GeneralLM::Rs_LM_fix_anova_03_2ways_RCode(my_dataset = my_dataset,
                                  var_name_rv = var_name_rv,
                                  var_name_factor01 = var_name_factor01,
                                  var_name_factor02 = var_name_factor02,
