...
<div style="font-size:30px; font-weight: bold; text-decoration: underline;"> Ancova with interaction - Fixed Model - General Linear Models</div>
...
var_name_cov <- params$"var_name_cov"
alpha_value <- as.numeric(as.character(params$"alpha_value"))

my_super_list <- Rscience.GeneralLM::Rs_LM_fix_ancova_01_with_RCode(my_dataset = my_dataset,
                                  var_name_rv = var_name_rv,
                                  var_name_factor = var_name_factor,
                                  var_name_cov = var_name_cov,
