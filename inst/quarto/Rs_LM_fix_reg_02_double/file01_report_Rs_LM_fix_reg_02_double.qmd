...
var_name_reg01 <- params$"var_name_reg01"
var_name_reg02 <- params$"var_name_reg02"
alpha_value <- as.numeric(as.character(params$"alpha_value"))

my_super_list <- Rscience.GeneralLM::Rs_LM_fix_reg_02_double_RCode(my_dataset = my_dataset,
                           var_name_rv = var_name_rv,
                           var_name_reg01 = var_name_reg01,
                           var_name_reg02 = var_name_reg02,
