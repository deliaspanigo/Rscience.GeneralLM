---
title: "Anova 1 Way and 1 Block - Fixed Model - General Linear Models"
format: 
  html:
    page-layout: custom
    margin-left: 0%
...
my_super_list <- Rscience.GeneralLM::Rs_LM_fix_anova_02_1way1block_RCode(my_dataset = my_dataset,
