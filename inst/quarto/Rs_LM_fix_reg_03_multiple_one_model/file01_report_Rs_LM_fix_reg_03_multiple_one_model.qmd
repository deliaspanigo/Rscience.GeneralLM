---
title: "Reg Multiple - Fixed Model - General Linear Models"
format: 
  html:
    page-layout: custom
    margin-left: 0%
...
<div style="font-size:30px; font-weight: bold; text-decoration: underline;"> Report - Reg Multiple - Fixed Model - General Linear Models</div>
...
var_name_reg <- eval(parse(text = params$"var_name_reg"))
alpha_value <- as.numeric(as.character(params$"alpha_value"))

my_super_list <- Rscience.GeneralLM::Rs_LM_fix_reg_03_multiple_one_model_RCode(my_dataset = my_dataset,
