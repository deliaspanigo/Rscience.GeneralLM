---
title: "Dummy with interaction - Fixed Model - General Linear Models"
format: 
  html:
    page-layout: custom
    margin-left: 0%
...
<div style="font-size:30px; font-weight: bold; text-decoration: underline;"> Dummy with interaction - Fixed Model - General Linear Models</div>
...
var_name_dummy <- params$"var_name_dummy"
var_name_reg <- params$"var_name_reg"
alpha_value <- as.numeric(as.character(params$"alpha_value"))

my_super_list <- Rscience.GeneralLM::Rs_LM_fix_dummy_01_with_RCode(my_dataset = my_dataset,
                                  var_name_rv = var_name_rv,
                                  var_name_dummy = var_name_dummy,
                                  var_name_reg = var_name_reg,
